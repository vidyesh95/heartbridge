                ...
                <div className={"space-y-4 md:space-y-8"}>
                    ...
                    <Card>
                        <CardContent className={"flex flex-row gap-4"}>
                            <div className={"w-12 h-12 shrink-0 flex items-center justify-center bg-primary rounded-full"}>
                    ...
                    <Card>
                        <CardContent className={"flex flex-row gap-4"}>
                            ...
                            <div>
                                ...
                                <p className={"text-muted-foreground"}>HeartBridge Classic Matrimonial Services123 Wedding Street, Love Plaza Mumbai, Maharashtra 400001 India</p>
                            </div>
                        </CardContent>
                    </Card>
                    <Card>
