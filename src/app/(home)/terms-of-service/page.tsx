  ...
  return (
    ...
    >
      <hgroup className={"space-y-4 text-center md:space-y-8"}>
        <h3 className={"text-4xl text-secondary-foreground md:text-6xl"}>Terms of Service</h3>
        <p className={"max-w-xl text-muted-foreground"}>Last updated: December 2025</p>
      </hgroup>
