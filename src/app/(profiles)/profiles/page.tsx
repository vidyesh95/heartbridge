    ...
    <section>
      ...
      <SidebarProvider className={"p-4"}>
        ...
        <main className={"flex-1"}>
          ...
          <div
            className={
              "mt-2 grid w-full grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5"
            }
          >
            {profiles.map((profile) => (
              <Card className={"w-full cursor-pointer overflow-hidden pt-0"} key={profile.id}>
                ...
                <CardContent>
                  <h5 className={"mb-2 text-lg font-semibold text-primary"}>{profile.name}</h5>
                  <p>
                  ...
                  <p>
                    Annual income:&nbsp;<span>{profile.annualIncome}</span>
                  </p>
                  <p>
