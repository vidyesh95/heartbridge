...
import {
  browseSearchParamsFromUrl,
  parseBrowseSearchParams,
} from "@/domain/profile/parse-browse-search-params";
import { PUBLIC_LISTING_LIMIT, publicListingFromProfile } from "@/domain/profile/public-listing";
...
export async function GET(request: NextRequest) {
  ...
  const filters = parseBrowseSearchParams(browseSearchParamsFromUrl(request.nextUrl.searchParams));
